    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (exportResults) {
            if (core.getInput('create_release') === 'true') {
                ...
                yield core.group(`Move exported games`, () => __awaiter(this, void 0, void 0, function* () {
                    yield io.mv(path.join(actionWorkingPath, 'builds'), path.join(relativeProjectPath, 'builds'));
                }));
            }
        }
        return 0;
